    ...
    public function run(): void
    {
        ...
        $properties = [
            ...
            [
                ...
                'description' => 'Spacious gated townhouse with staff quarters, rooftop lounge, and quick access to embassies and business districts.',
                'price' => 485000,
                'currency' => 'USD',
                'price_period' => 'year',
                'deposit' => 50000,
                ...
                'floor' => 2,
                'year_built' => 2021,
                'address' => 'Second Rangoon Close, Cantonments',
                'city' => 'Accra',
                'region' => 'Greater Accra',
                'country' => 'Ghana',
                'postal_code' => 'GA-105-9921',
                'latitude' => 5.5778,
                'longitude' => -0.1703,
                'amenities' => ['WiFi', 'Air conditioning', 'Parking', 'Gym', 'Balcony', 'Security cameras'],
                'pets_allowed' => ['Cats', 'Dogs'],
                'is_featured' => true,
                'is_verified' => true,
                'image_set' => ['assets/img/listings/real-estate/01.jpg', 'assets/img/listings/real-estate/02.jpg'],
            ],
            [
                'title' => 'Serviced Plot in East Legon Hills',
                'description' => 'Titled roadside plot within a fast-growing enclave with power and water lines already in place.',
                'price' => 420000,
                'currency' => 'GHS',
                'price_period' => 'year',
                'deposit' => 50000,
                ...
                'region' => 'Greater Accra',
                'country' => 'Ghana',
                'postal_code' => 'GA-552-7810',
                'latitude' => 5.7222,
                'longitude' => -0.1163,
                'amenities' => ['Titled', 'Roadside', 'Serviced', 'Utility access'],
                'pets_allowed' => [],
                'is_verified' => true,
                'image_set' => ['assets/img/listings/real-estate/03.jpg'],
            ],
            [
                'title' => 'Retail Space on Oxford Street, Osu',
                'description' => 'High-visibility frontage along Oxford Street, ideal for fashion, beauty, or quick-service retail.',
                'price' => 38000,
                'currency' => 'GHS',
                'price_period' => 'month',
                'deposit' => 76000,
                ...
                'region' => 'Greater Accra',
                'country' => 'Ghana',
                'postal_code' => 'GA-064-4412',
                'latitude' => 5.5604,
                'longitude' => -0.1801,
                'amenities' => ['Frontage', 'Signage visibility', 'Washroom', 'Parking', 'High foot traffic'],
                'pets_allowed' => [],
                'is_featured' => true,
                'image_set' => ['assets/img/listings/real-estate/04.jpg'],
            ],
            [
                'title' => 'Grade A Office Suite at Ridge',
                'description' => 'Modern office floorplate with reception area, backup power, lift access, and secure parking.',
                'price' => 6200,
                'currency' => 'EUR',
                'price_period' => 'month',
                'deposit' => 12400,
                ...
                'region' => 'Greater Accra',
                'country' => 'Ghana',
                'postal_code' => 'GA-079-1034',
                'latitude' => 5.5654,
                'longitude' => -0.1986,
                'amenities' => ['Parking', 'Backup power', 'Elevator', 'Conference room', 'CCTV', 'Security'],
                'pets_allowed' => [],
                'is_verified' => true,
                'image_set' => ['assets/img/listings/real-estate/05.jpg'],
            ],
            [
                'title' => 'Warehouse Near Tema Port',
                'description' => 'Logistics-ready warehouse with truck access, loading bay, secure yard, and stable power supply.',
                'price' => 14500,
                'currency' => 'USD',
                'price_period' => 'month',
                'deposit' => 29000,
                ...
                'region' => 'Greater Accra',
                'country' => 'Ghana',
                'postal_code' => 'TM-229-8810',
                'latitude' => 5.6698,
                'longitude' => 0.0166,
                'amenities' => ['Loading bay', 'Truck access', 'High clearance', 'Power supply', 'Security', 'Parking'],
                'pets_allowed' => [],
                'image_set' => ['assets/img/listings/real-estate/06.jpg'],
            ],
            [
                'title' => 'Beachfront Villa in Kokrobite',
                'description' => 'Premium shortlet villa with ocean views, private pool, and concierge-ready guest layout.',
                'price' => 950,
                'currency' => 'GBP',
                'price_period' => 'day',
                'deposit' => 950,
                ...
                'floor' => 2,
                'year_built' => 2020,
                'address' => 'Kokrobite Beach Road',
                'city' => 'Accra',
                'region' => 'Greater Accra',
                'country' => 'Ghana',
                'postal_code' => 'CB-118-5520',
                'latitude' => 5.5051,
                'longitude' => -0.3285,
                'amenities' => ['WiFi', 'Air conditioning', 'Pool', 'Balcony', 'Parking', 'Security cameras'],
                'pets_allowed' => ['Dogs'],
                'is_featured' => true,
                'is_verified' => true,
                'image_set' => ['assets/img/listings/real-estate/02.jpg', 'assets/img/listings/real-estate/03.jpg'],
            ],
        ];
        ...
        foreach ($properties as $index => $data) {
            ...
            $pricePeriod = $data['price_period'] ?? match ($listingType) {
                'sale' => 'year',
                'shortlet' => 'day',
                default => 'month',
            };
            $deposit = $data['deposit'] ?? match ($listingType) {
                'sale' => (int) round($data['price'] * 0.1),
                'shortlet' => (int) $data['price'],
                default => (int) ($data['price'] * 2),
            };
            ...
            $property = Property::updateOrCreate(
                ...
                [
                    ...
                    'title' => $title,
                    'description' => $data['description'] ?? 'Comfortable living area, renovated kitchen, and easy access to transportation hubs.',
                    'price' => $data['price'],
                    ...
                    'area' => $data['area'],
                    'year_built' => $data['year_built'] ?? ($propertyType === 'land' ? null : 2023),
                    'floor' => $data['floor'] ?? null,
                    'total_rooms' => $data['total_rooms'] ?? (isset($data['bedrooms']) ? max(2, $data['bedrooms'] + 1) : null),
                    'address' => $data['address'] ?? $title,
                    'city' => $data['city'] ?? 'Brooklyn',
                    'region' => $data['region'] ?? 'NY',
                    'country' => $data['country'] ?? 'USA',
                    'postal_code' => $data['postal_code'] ?? '11211',
                    'latitude' => $data['latitude'],
                    'longitude' => $data['longitude'],
                    'map_embed_url' => $data['map_embed_url'] ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2311.3724100313693!2d-73.82417211551919!3d42.62335692577899!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89dde016efd1fe73%3A0x6861561b35064fe9!2sGlendale%20Ave!5e0!3m2!1sen!2suk!4v1726842151281!5m2!1sen!2suk',
                    'amenities' => $data['amenities'] ?? ['WiFi', 'Air conditioning', 'Parking', 'Laundry', 'Security cameras'],
                    'pets_allowed' => $data['pets_allowed'] ?? ['Cats', 'Dogs'],
                    'status' => 'live',
                    'visibility' => 'public',
