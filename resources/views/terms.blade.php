...
@section('title', 'Propsgh | Terms & Conditions')
@section('meta_description', 'Terms and conditions for using the Propsgh platform.')
...
<style>
  ...
  .legal-hero::before {
    ...
    inset: 0;
    background:
      radial-gradient(ellipse 60% 50% at 20% 80%, rgba(14, 165, 233, 0.12), transparent),
      radial-gradient(ellipse 50% 40% at 80% 20%, rgba(139, 92, 246, 0.08), transparent);
    pointer-events: none;
  }
  .legal-hero-content {
    position: relative;
...
<div class="legal-page">
  ...
  <div class="legal-hero">
    <div class="legal-hero-content">
      <span class="legal-hero-tag"><i class="fi-file-text"></i> Legal</span>
