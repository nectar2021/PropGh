...
trait ValidatesPropertyListing
{
    /**
     * @return array<string, \Illuminate\Contracts\Validation\ValidationRule|array<mixed>|string>
     */
    protected function propertyRules(bool $requiresImages, bool $includeAdminFields = false): array
    {
        $rules = [
            ...
            'year_built' => $this->nonLandYearBuiltRules(),
            ...
            'images' => [$requiresImages ? 'required' : 'nullable', 'array', $requiresImages ? 'min:1' : 'sometimes', 'max:10'],
        ...
        if ($includeAdminFields) {
            $rules = [
                ...
                ...$rules,
                'status' => ['required', Rule::in(['live', 'draft', 'review'])],
    ...
    protected function normalizePropertyInput(): void
    {
        $this->merge([
    ...
    public function propertyData(): array
    {
        ...
        return PropertyCatalog::normalizeListingData($data);
    }
     ...
     * @return array<int, mixed>
     */
    private function nonLandYearBuiltRules(): array
    {
        return [
            Rule::excludeIf($this->isLandProperty()),
            'nullable',
